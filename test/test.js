...
describe('abi decoder', function () {
  ...
  it('decode sigs', () => {
    abiDecoder.addABI(testABI);
    const testData = "";
    const sigs = abiDecoder.decodeSigs(testData);
    expect(sigs).length.to.be.be(1);
    expect(sigs[0]).to.equal('create(address[],uint256,uint256)')
  });
